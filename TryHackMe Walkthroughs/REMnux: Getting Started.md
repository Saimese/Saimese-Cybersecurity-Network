...
The REMnux VM is a customized Linux distribution. Tools like Volatility, YARA, Wireshark, oledump, and INetSim are already included. Additionally, it offers a sandbox-like setting for analyzing possibly dangerous software without endangering your main system. Without having to deal with the inconvenience of manual installations, your lab is ready to go.
